...
public class ItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final PrestamosDisplayList clickedItem = (PrestamosDisplayList) getIntent().getExtras().getSerializable("DATA");
        ...
        Pair<String, String> item_tuple_copyid = new Pair<String, String>("Número de copia", Integer.toString(clickedItem.getCopyid()));
        ...
        if (clickedItem.getDaysLate() > 0) {
            Pair<String, String> item_tuple_dayslate = new Pair<String, String>("Días de retraso", Integer.toString(clickedItem.getDaysLate()));
            item_data.add(item_tuple_dayslate);
        }
        ...
        ArrayAdapter adapter = new ArrayAdapter(this, android.R.layout.simple_list_item_2, android.R.id.text1, item_data) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                text1.setTypeface(ResourcesCompat.getFont(ItemActivity.this, R.font.roboto_light));
